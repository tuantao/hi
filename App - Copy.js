      ...
      <ScrollView bounces={false} alwaysBounceVertical={false} overScrollMode="never" showsVerticalScrollIndicator={false}
        ...
        <View style={{ width: SW, height: H }}>
          ...
          >
            <Text
              style={{
                // KHÔNG dùng overlayStyles.balNumber vì style đó có position:'absolute'  :contentReference[oaicite:0]{index=0}
                color: '#fff',
            ...
            return (
              <>
                ...
                <View style={[confirmStyles.valueContainer, { top: by(POS.note.top), right: 35, left: 35 }]}>
                  <Text style={[confirmStyles.value, { textAlign: POS.note.align, fontFamily: FONT_HEAVY }]}>{formatNote(details.note)}</Text>
                </View>
...
<ImageBackground source={BgSuccess} style={{ width: SW, minHeight: H }} resizeMode="contain">
        ...
        {/* Nội dung chuyển */}
        <View style={[confirmStyles.valueContainer, { top: by(POS.note.top), right: 35, left: 35 }]}>
          <Text style={[confirmStyles.value, { textAlign: 'right', fontFamily: FONT_HEAVY }]}>
